...
String win_topbar = "closed=\"true\" modal=\"true\" collapsible=\"false\"  draggable=\"false\" minimizable=\"false\" maximizable=\"false\" resizable=\"false\"";
      ...
      out.write("\t\t\t\t\t\t\t<option value=\"new\">上架时间</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"price\">价格</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"sale\">销量</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"cpoint\">评分</option>\r\n");
